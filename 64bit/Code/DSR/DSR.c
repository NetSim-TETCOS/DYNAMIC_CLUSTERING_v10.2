...
{
	//This #ifdef.....#endif block defines the Dynamic Clustering Metrics, which shows the packets 
...
#ifdef _DYNAMIC_CLUSTERING
	PMETRICSNODE table = init_metrics_node(MetricsNode_Table, "Dynamic Clustering Metrics", NULL);
	...
	PMETRICSNODE menu = init_metrics_node(MetricsNode_Menu, "Dynamic Clustering Metrics", NULL);
